...
function App() {
  return (
    <div className="text-gray-100">
      <header className="fixed top-0 inset-x-0 opacity-[0.9] backdrop-blur-[10px] z-[1000] shadow-sm py-[1.5rem] flex justify-evenly items-center  bg-gradient-to-r from-[#0F0F0F] to-[#1F1F1F]">
